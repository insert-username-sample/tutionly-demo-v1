      ...
      <div className="max-w-4xl mx-auto px-6 xl:px-0 pb-12">
        ...
        >
          <GlassCard className="p-8 text-center">
            ...
            >
              Tuitionly transforms education through AI-driven personalization.
              Our platform adapts to every student's unique learning journey,
              combining one-on-one tutoring sessions with advanced analytics to
              create the perfect study experience customized just for them.
            </p>
          </GlassCard>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <GlassCard className="p-8">
              ...
              >
                Tuitionly was created as a solution to provide a
